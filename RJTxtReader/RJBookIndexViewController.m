...
- (void)viewDidLoad
{
    ...
    bookIndexTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, myHight-45)];
    ...
    bookmarkTableView = [[UITableView alloc] initWithFrame:CGRectMake(0, 0, 320, myHight-45)];
